...
namespace diet {
    ...
    private:
        ...
        std::wstring plan_ = L"Для расщепления углеводов нужна щелочная среда, белкам же нужна кислая среда. Соответственно, и есть их нужно в разное время! Этот принцип лег в основу самой легкой диеты для ленивых, которую особенно ценят любители поесть часто и обильно.\n"
